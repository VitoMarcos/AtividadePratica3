...
int op;
        do {
            System.out.println("\nSelecione o tipo de funcionário que deseja cadastrar");
        ...
        switch (op) {
            ...
            case 2:
            System.out.print("Nome: ");
            String nomeD = Console.lerString();
            System.out.print("Matricula: ");
            int matriculaD = Console.lerInt();
            System.out.print("Salário: ");
            float salarioD = Console.lerFloat();
            System.out.print("Linguagem dominante: ");
            String linguagens = Console.lerString();

                Desenvolvedor d = new Desenvolvedor(nomeD, matriculaD, salarioD, linguagens);
            ...
            case 3:
            System.out.print("Nome: ");
            String nomeE = Console.lerString();
            System.out.print("Matricula: ");
            int matriculaE = Console.lerInt();
            System.out.print("Salário: ");
            float salarioE = Console.lerFloat();
            System.out.print("Horas trabalhadas: ");
            int horas = Console.lerInt();
            System.out.print("Nome do supervisor: ");
            String supervisor = Console.lerString();

                Estagiario e = new Estagiario(nomeE, matriculaE, salarioE, horas, supervisor);
